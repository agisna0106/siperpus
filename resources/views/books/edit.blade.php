        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form method="post" action="{{ route('books.update', $book->id) }}" enctype="multipart/form-data" class="mt-6 space-y-6">
                    ...
                    <div class="max-w-xl">
                        <x-input-label for="" value="Tahun Terbit"/>
                    ...
                    <div class="max-w-xl">
                        ...
                        <x-select-input id="category_id" name="category_id" class="mt-1 block w-full" required>
                            <option value="category_id">Open this select menu</option>
                            @foreach($category as $key => $value)
                                @if(old('category_id', $book->category_id) == $key)
                    ...
                    <div class="max-w-xl">
                        ...
                        <x-select-input id="bookshelf_id" name="bookshelf_id" class="mt-1 block w-full" required>
                            <option value="bookshelf_id">Open this select menu</option>
